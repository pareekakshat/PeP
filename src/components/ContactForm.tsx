            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-gray-600">+91 1234567890</span>
                </div>
                <div className="flex items-center">
                  <Mail className="h-6 w-6 text-indigo-600" />
                  <span className="ml-4 text-gray-600">contact@pareekeducation.com</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="h-6 w-6 text-indigo-600" />
                  <span className="ml-4 text-gray-600">123 Education Street, Jaipur, Rajasthan</span>
                </div>
              </div>
            </div>
